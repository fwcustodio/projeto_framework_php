...
class ConfigSIS {
    ...
    function setDiretorios() {
        ...
        if (!isset($_SESSION['DirBase'])) {
            ...
            echo $_SESSION['DirBaseSite'];
            echo '<br>';
            echo $_SESSION['UrlBaseSite'];
            echo '<br>';
            echo $_SESSION['DirBase'];
            echo '<br>';
            echo $_SESSION['UrlBase'];
            echo '<br>';
            echo $_SESSION['LocalDir'];
            echo '<br>';
            echo $_SESSION['UrlFMBase'];
            echo '<br>';
            echo $_SESSION['FMBase'];
            echo '<br>';
            echo $_SESSION['JSBase'];
            echo '<br>';
            echo $_SESSION['CSSBase'];
            echo '<br>';
