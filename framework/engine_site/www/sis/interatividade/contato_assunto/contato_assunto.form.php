...
class AssuntoForm extends FormCampos
{
	public function AssuntoForm()
	{
		parent::FormCampos();
	}
	...
	public function getFormFiltro()
	{
		...
		$Assunto = parent::inputSuggest(array(
		"Nome"        => "Assunto",
		"Identifica"  => "Assunto",
		"TipoFiltro"  => "Suggest",
		"Valor"       => parent::retornaValor($Metodo,"Assunto"),
		"Largura"     => 30,
		"Tabela"      => "contato_assunto",
		"Campo"       => "Assunto"),false);
		parent::setFiltro(true,"Assunto:",$Assunto,1);
	...
	public function getFormManu()
	{
		...
		$R["Assunto"] = parent::inputTexto(array(
		"Nome"        => "Assunto",
		"Identifica"  => "Assunto",
		"TipoFiltro"  => "Texto",
		"Valor"       => parent::retornaValor($Metodo,"Assunto"),
