...
class ContatoCategoriaForm extends FormCampos
{
	public function ContatoCategoriaForm()
	{
		parent::FormCampos();
	}
	...
	public function getFormFiltro()
	{
		...
		$ContatoCategoria = parent::inputSuggest(array(
		"Nome"        => "ContatoCategoria",
		"Identifica"  => "Categoria",
		"TipoFiltro"  => "Suggest",
		"Valor"       => parent::retornaValor($Metodo,"ContatoCategoria"),
		"Largura"     => 30,
		"Tabela"      => "contato_categoria",
		"Campo"       => "ContatoCategoria"),false);
		parent::setFiltro(true,"Categoria:",$ContatoCategoria,1);
	...
	public function getFormManu()
	{
		...
		$R["ContatoCategoria"] = parent::inputTexto(array(
		"Nome"        => "ContatoCategoria",
		"Identifica"  => "Categoria",
		"TipoFiltro"  => "Texto",
		"Valor"       => parent::retornaValor($Metodo,"ContatoCategoria"),
