...
{		
	...
	*/
	...
	{		
		$Sql = "SELECT b.EnderecoDadosTipo, a.Pais, a.Estado, a.Cidade, a.Rua, a.Numero, a.Bairro, a.CEP, a.Complemento, a.Mapa
	...
	{		
		...
		$Sql = "INSERT INTO endereco_dados  
				(EnderecoCod, EnderecoDadosTipoCod, Pais, Estado, Cidade, Rua, Numero, Bairro, CEP, Complemento, Mapa, Padrao) VALUES 
				($this->EnderecoCod, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)";
	...
	{
		$Sql = "SELECT EnderecoDadosCod, EnderecoDadosTipoCod, Pais, Estado, Cidade, Rua, Numero, Bairro, CEP, Complemento, Mapa, Padrao
				FROM   endereco_dados  
