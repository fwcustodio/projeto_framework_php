...
<legend class="legendaManu"><?=$Ac->opcaoExt($Op);?></legend>
  <form id="FormManu<?=$Id?>" name="FormManu<?=$Id?>" method="post" action="" onSubmit="return false" >
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr><td width="170" align="right" class="textoForm">Departamento:</td><td><?=$Campos['Departamento']?></td></tr>
		<tr><td width="170" align="right" class="textoForm">Status:</td><td><?=$Campos['Status']?><input type="hidden" name="Finalidade" id="Finalidade" value="Co" /></td></tr>
		...
		<tr>
		  <td align="right" valign="top" class="textoForm"><img border="0" src="<?=$_SESSION['UrlBase']?>figuras/bt_add_user.gif" onclick="addDados('<?=$Id?>')" style="cursor:pointer" /></td>
		  <td class="textoFormInterno"><div id="conteiner_usuarios"><?=$ConteudoUsuarios?></div></td>
	    </tr>
		<tr>
		  <td align="right" class="textoForm">&nbsp;</td>
		  <td class="textoFormInterno">&nbsp;</td>
