...
class Assunto extends AssuntoSQL
{	
	/*
	*	Seta a Cѓdigo Chave	
	*	@return String
	...
	*/	
	...
	{		
		...
		$Gr->setListados(array("Assunto"));
		$Gr->setTitulos(array("Assunto"));
	...
	*/	
	...
	{	
		...
		$Gr->setListados(array("ContatoAssuntoCod", "Assunto"));
		$Gr->setTitulos(array("Cѓdigo", "Assunto"));
	...
	public function remover()
	{
		...
		{	
			...
			{		
				if
				(
					$Con->existe("contato_mensagem", "AssuntoCod", $Chave)
				)
				{
					$Mensagem[] = $Con->execRLinha(parent::getDadosSql($Chave),"Assunto").' jс esta sendo usado no sistema!';	
				}
				else 
				{				
