...
class EnderecoCategoria extends EnderecoCategoriaSQL
{	
	/*
	*	Seta a Cѓdigo Chave	
	*	@return String
	...
	*/
	public function getParametros()
	{
		...
		$MeusParametros = array("EnderecoDadosTipo");
	...
	*/	
	...
	{		
		...
		$Gr->setListados(array("EnderecoDadosTipo"));
	...
	*/	
	...
	{	
		...
		$Gr->setListados(array("EnderecoDadosTipoCod", "EnderecoDadosTipo"));
	...
	public function remover()
	{
		...
		{	
			...
			{		
				if
				(
					$Con->existe("endereco_dados", "EnderecoDadosTipoCod", $Chave)
				)
				{
					$Mensagem[] = $Con->execRLinha(parent::getDadosSql($Chave),"EnderecoDadosTipo").' jс esta sendo usado no sistema!';	
				}
				else 
				{				
	...
	*/	
	public function getDados($Id, $Metodo)
	{
		...
		//Define Campos
		$Campos   = array("Id", "EnderecoDadosTipo");
