...
class EnderecoCategoriaForm extends FormCampos
{
	public function EnderecoCategoriaForm()
	{
		parent::FormCampos();
	}
	...
	public function getFormFiltro()
	{
		...
		$EnderecoDadosTipo = parent::inputSuggest(array(
		"Nome"        => "EnderecoDadosTipo",
		"Identifica"  => "Categoria",
		"TipoFiltro"  => "Suggest",
		"Valor"       => parent::retornaValor($Metodo,"EnderecoDadosTipo"),
		"Largura"     => 30,
		"Tabela"      => "endereco_dados_tipo",
		"Campo"       => "EnderecoDadosTipo"),false);
		parent::setFiltro(true,"Categoria:",$EnderecoDadosTipo,1);
	...
	public function getFormManu()
	{
		...
		$R["EnderecoDadosTipo"] = parent::inputTexto(array(
		"Nome"        => "EnderecoDadosTipo",
		"Identifica"  => "Categoria",
		"TipoFiltro"  => "Texto",
		"Valor"       => parent::retornaValor($Metodo,"EnderecoDadosTipo"),
